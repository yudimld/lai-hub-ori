				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Opportunity List Status</h2>
								<h5 class="text-white op-7 mb-2">List Opportunity Request to PPIC</h5>
							</div>
						</div>
					</div>
				</div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control bg-light" id="modalStatusQty">
                                                    </div>
                                                    <div class="col-md-6">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#status-request-table').on('click', '.btn-edit', function () {
                ...
                fetch(`/salesmarketing/csr/api/status-request-ppic/${id}`)
            ...
            $('#modalRequestToPpicButton').on('click', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch(`/salesmarketing/csr/api/ppic-eticket/update-status/${id}`, {
                            method: 'PUT',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
