				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Dashboard EDC</h2>
								<h5 class="text-white op-7 mb-2">Data Project Engineering Development Center</h5>
							</div>
						</div>
					</div>
				</div>
										...
										<div class="col-md-6">
											<div class="card">
												<div class="card-header">
													<div class="card-title">Persentase Kategori Project</div>
												</div>
												<div class="card-body">
